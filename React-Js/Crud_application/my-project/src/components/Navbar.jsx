...
import logo from '/src/assets/i_phonelogo.png'
...
return (
  <div className="relative w-full bg-white">
    <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-2 sm:px-6 lg:px-8 border mt-6">
      <div className="inline-flex items-center space-x-2">
        <span>
          <img className='w-32' src={logo} alt="" />
        </span>
        <span className="font-bold">I PHONE</span>
      </div>
    ...
    {/* <div className='flex flex-wrap px-10 py-4   '>
      ...
      <div className="flex grow justify-start mt-4 w-full md:w-auto">
        <div className="flex items-center relative">
          <IoSearchSharp className="h-5 w-5 mr-2 text-gray-600 absolute ml-52" />
          <input
