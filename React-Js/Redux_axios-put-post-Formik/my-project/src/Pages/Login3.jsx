                ...
                <form onSubmit={formik.handleSubmit}>
                    <div className='bg-blue-400 text-white  p-10 border-4 border-double  border-blue-800 flex flex-col '>
                        <div className='mb-4 flex flex-col'>
                            ...
                            <input type="text" className='text-black' name="firstname" id="firstName" value={formik.values.firstname} onChange={formik.handleChange} onBlur={formik.handleBlur} />
                            {                              
                        ...
                        <div className='mb-4 flex flex-col'>
                            ...
                            <input type="text" className='text-black' name="lastname" id="lastName" value={formik.values.lastname} onChange={formik.handleChange} onBlur={formik.handleBlur}/>
                            {
                        ...
                        <div className='mb-4 flex flex-col'> 
                            ...
                            <input type="text" className='text-black' name="email" id="email" value={formik.values.email} onChange={formik.handleChange} onBlur={formik.handleBlur}/>
                            {
                        ...
                        <div className='mb-4 flex flex-col'>
                            ...
                            <input type="text" className='text-black' name="password" id="password" value={formik.values.password} onChange={formik.handleChange} onBlur={formik.handleBlur} />
                            {
